...
public class MainActivity<ServiceConnection> extends AppCompatActivity implements SensorEventListener{
    ...
    int movementType; //0 if still, 1 if moving
    ...
    /*
    int t1 = R.raw.dayMovingMild;
    int t2 = R.raw.dayMovingCool;
    int t3 = R.raw.dayMovingWarm;

    int t4 = R.raw.daySittingNoiseMild;
    int t5 = R.raw.daySittingNoiseCool;
    int t6 = R.raw.daySittingNoiseWarm;

    int t7 = R.raw.daySittingQuietMild;
    int t8 = R.raw.daySittingQuietCool;
    int t9 = R.raw.daySittingQuietWarm;

    int t10 = R.raw.nightSittingNoiseMild;
    int t11 = R.raw.nightSittingNoiseCool;
    int t12 = R.raw.nightSittingNoiseWarm;

    int t13 = R.raw.nightSittingNoiseMild;
    int t14 = R.raw.nightSittingNoiseCool;
    int t15 = R.raw.nightSittingNoiseWarm;

    int t16 = R.raw.nightSittingQuietMild;
    int t17 = R.raw.nightSittingQuietCool;
    int t18 = R.raw.nightSittingQuietWarm;
    */
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER){
            ...
            //if change is below 1.1, qualify as noise
            if (deltaX < .6)
                deltaX = 0;
            if (deltaY < .6)
                deltaY = 0;
            ...
            if ((deltaX > 7) || (deltaY > 7) || (deltaZ > 8)) {
                //sharper movements = higher activity score
                activity += 2;
            }
            else if ((deltaX > 4) || (deltaY > 4) || (deltaZ > 2.5)) {
